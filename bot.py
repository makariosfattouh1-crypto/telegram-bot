...
bot_token = '8952817337:AAH55f_cUI_Q5y2A9V65Xf_7B8XLgapySyM'
bot = telebot.TeleBot(bot_token)
user_data = {}
allowed_users = ['5831193562']
admin_id = '5831193562' 
subscription_data = {}

keyboard = telebot.types.InlineKeyboardMarkup(row_width=2)
btn_add_recipient = telebot.types.InlineKeyboardButton('تعيين ايميل مستلم', callback_data='add_recipient')
...
btn_delete_klishes = telebot.types.InlineKeyboardButton('بوت رفع خارجي' , url='http://t.me/Rafe3_gmailbot')
...
def show_admin_commands(message):
    if str(message.from_user.id) == '5831193562': 
